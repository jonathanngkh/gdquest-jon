...
func part_010_adding_chest() -> void:
	...
	bubble_add_text([
		gtr("Press [b]Ctrl+S[/b] on your keyboard (Cmd+S on macOS) to save the [b]RoomA[/b] scene."),
	...
	bubble_add_text([
		...
		gtr("Press [b]F8[/b] on your keyboard or close the game window to return to the editor."),
	])
...
func part_020_first_line_of_code() -> void:
	...
	bubble_add_text([
		...
		gtr("Once you're done, press [b]F8[/b] on your keyboard or close the game window to return to the editor."),
	])
	bubble_add_task_press_button(interface.run_bar_play_current_button, "Play Current Scene")
	complete_step()
